...
contract Oracle {
    ...
    constructor() {
        ...
        ETH = IERC20(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419)
...
function checkETHPrice(uint upperThreshold, uint lowerThreshold) public view returns (bool){
    return getETHLatestPrice() < upperThreshold && getETHLatestPrice() > lowerThreshold;
}